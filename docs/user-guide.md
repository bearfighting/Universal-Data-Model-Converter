...
- Java is limited to one public root `record` per source file, with
  package-private record definitions; classes, interfaces, annotations, enums,
  generics, and JavaBeans remain unsupported;
