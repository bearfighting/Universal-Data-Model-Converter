...
| Python Dataclass | Shape              | Python 3.10+ dataclasses                       | dataclass type-shape subset; shared `rootName` preserves known root declarations; no defaults, runtime behavior, inheritance, or generics |
