...
| Python Dataclass | Shape              | Python 3.10+ dataclasses                       | dataclass type-shape subset; root declaration names may normalize to document identity; no defaults, runtime behavior, inheritance, or generics |
