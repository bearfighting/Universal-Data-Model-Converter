...
Output targets Python 3.10+ and uses the supported generic forms `list[T]` and
`T | None`. Definitions are emitted deterministically as standalone
dataclasses. Optional field presence
